                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body vh-100 d-flex justify-content-center align-items-center flex-column">
                        ...
                        <form class="contact-form container mt-5" onSubmit={handleSubmit(onSubmit)}>
                            <h3 className="mb-30">Register Now</h3>
                            <div class="row mb-10">
                                <div class="col-7">
                                    <div class="contact-field p-relative c-name mb-20">
                                        <input class="form-control form-control-lg shadow-lg p-3 mb-5 bg-white rounded"
                                            type="text"
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="slider-btn">
                                        <button class="main-btn btn-lg" data-animation="fadeInRight" data-delay=".8s">Register Now</button>
                                    </div>
                                </div>
