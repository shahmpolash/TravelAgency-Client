...
const UpdateVideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagency-a887203e1d88.herokuapp.com/video/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://travelagency-a887203e1d88.herokuapp.com/update-video/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                        ...
                        <div class="col-lg-8 col-md-12">
                            ...
                            <form class="contact-form " onSubmit={handleVideoSection}>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="contact-field p-relative c-name mb-20">
                                            <input type="text" id="firstn" name="videoLink" defaultValue={video.videoLink} placeholder="video Link" required />
                                        </div>
                                    </div>

                                    <div class="slider-btn">
                                        <button class="main-btn" data-animation="fadeInRight" data-delay=".8s"> Update Video Section </button>
                                    </div>
                                </div>
