...
const UpdateUser = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagency-a887203e1d88.herokuapp.com/users/${id}`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://travelagency-a887203e1d88.herokuapp.com/upadete-users/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="slider-btn ">
                                        <button class="main-btn" data-animation="fadeInRight" data-delay=".8s"> Update User Email </button>
