...
const FooterCopyright = () => {
    ...
    const handleFooterCopyright = (event) => {
        ...
        const url = `https://travelagency-a887203e1d88.herokuapp.com/add-footer-copyright`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <>
                                    {
                                        footercopyright.map(c =>
                                            footercopyright.map(c =>
                                                <Link className='main-btn' to={`/edit-copyright/${c._id}`}> Please Edit About Footer</Link>)
