...
const AddPaypalEmail = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagency-a887203e1d88.herokuapp.com/paypal-email`)
            .then((res) => res.json())
    ...
    const handleEmailSection = (event) => {
        ...
        const url = `https://travelagency-a887203e1d88.herokuapp.com/add-email`;
        fetch(url, {
            method: "POST",
            headers: {
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="slider-btn ">
                                        <button class="main-btn" data-animation="fadeInRight" data-delay=".8s"> Add Paypal Email </button>
