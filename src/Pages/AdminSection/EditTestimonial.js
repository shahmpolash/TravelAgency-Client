...
const EditTestimonial = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagency-a887203e1d88.herokuapp.com/testimonial/${id}`)
            .then((res) => res.json())
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://travelagency-a887203e1d88.herokuapp.com/testimonial/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleTestimonialSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="main-btn" data-animation="fadeInRight" data-delay=".8s"> Update Testimonial </button>
                                    </div>
                                </div>
