...
const VideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagency-a887203e1d88.herokuapp.com/video`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://travelagency-a887203e1d88.herokuapp.com/add-video`;
        fetch(url, {
            method: "POST",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleVideoSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="main-btn" data-animation="fadeInRight" data-delay=".8s"> Update Section </button>
                                    </div>
                                </div>
